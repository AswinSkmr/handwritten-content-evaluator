...
print(f"Identical texts (n=3):        {compute_ngram_overlap(identical, identical, n=3):.4f}")
print(f"Similar texts (n=3):          {compute_ngram_overlap(identical, similar, n=3):.4f}")
print(f"Different texts (n=3):        {compute_ngram_overlap(identical, different, n=3):.4f}")
print(f"Short snippet in long doc (n=3): {compute_ngram_overlap(short_copied_snippet, long_doc_containing_snippet, n=3):.4f}")